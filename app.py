...
# --- Page Config & Styling ---
st.set_page_config(page_title="Rock🪨 vs Mine💣 Classifier", layout="centered") st.markdown( """ <style> .main {background-color: #F5F5F5; padding: 2rem; border-radius: 1rem; margin-bottom: 4rem;} .title {font-size: 3rem; color: #white; font-weight: bold; margin-bottom: 1rem;} .footer {position: fixed; left: 0; bottom: 0; width: 100%; background-color: #333333; color: white; text-align: center; padding: 1rem;} a {color: #1E88E5;} </style> """, unsafe_allow_html=True )
